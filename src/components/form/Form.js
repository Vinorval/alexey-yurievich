        ...
        <section className={Styles.contact}>
            ...
            <form className={Styles.form}>
                <fieldset className={Styles.inputs}>
                    <input className={`${Styles.input} ${Styles.input_width_long}`} id="name" placeholder="Ваше имя"></input>
                    ...
                    <input className={`${Styles.input} ${Styles.input_width_long}`} id="theme" placeholder="Тема сообщения"></input>
                    <textarea className={`${Styles.input} ${Styles.input_type_area} ${Styles.input_width_long}`} id="text" placeholder="Сообщение"></textarea>
                </fieldset>
